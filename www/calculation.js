...
const firebaseConfig = {
  ...
  storageBucket: "mygaji-7212c.firebasestorage.app",
...
export { calcStaffOT, calcPartTime, publlicHoliday, overTime, unpaidLeave, db, addDoc, getDoc , collection, doc, updateDoc, app };
